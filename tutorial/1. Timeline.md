...
Xuống cuối dòng và viết hết đống này vào:
...
Đến lúc thành coder thực thụ rồi, Trong này có 2 chỗ cần thay thế:
...
Nếu bạn đã đi đến đây thì tốt quá. Hãy đăng bài để chờ được duyệt. Giờ bạn sẽ thấy hiệu ứng 'Sticky' và cả khả năng 'Dịch chuyển'.
